  ...
  <div class="flex h-full flex-col">
    ...
    >
      <div class="flex items-center gap-3">
        ...
        <Badge variant="secondary" class="text-[10px]">Preview / Program</Badge>
      ...
      <div class="flex items-center gap-3">
        ...
        <Button variant="ghost" class="resolve-btn">
          <FolderOpen class="size-3.5" />
          Charger
        </Button>
        <Button variant="default" class="resolve-btn" @click="copyToProgram">
          <Copy class="size-3.5" />
          Copy to Program
        </Button>
      </div>
    ...
    <div v-if="project" class="flex flex-1 overflow-hidden">
      <!-- Preview -->
      <div class="flex flex-1 flex-col border-r border-[var(--border-panel)]">
    ...
    <div v-else class="flex flex-1 items-center justify-center">
      <p class="text-sm text-[var(--text-muted)]">Aucun projet chargé</p>
    </div>
  </div>
</template>
